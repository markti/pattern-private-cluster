...
// Provisions a node pool that attempts to allocate VMs in each specified zone. 
// **IMPORTANT:** This is BEST EFFORT. Therefore not all three AZs are gauranteed.
